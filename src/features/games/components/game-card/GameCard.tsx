  ...
  if (page === 'Home' && game) {
    return (
      <Card.Content style={styles.content}>
        <Card mode="outlined" style={[styles.cardHome, { backgroundColor: theme.colors.surface }]}>
          <Image
            source={
  ...
  if (page === 'Games' && game) {
    return (
      <Card.Content style={styles.contentGames}>
        <Card mode="outlined" style={[styles.cardGames, { backgroundColor: theme.colors.surface }]}>
